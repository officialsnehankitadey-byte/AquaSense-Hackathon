  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-bold text-lg tracking-tight text-white font-mono">Aqua<span className="text-cyan-400">Sense</span></span>
                <span className="text-[10px] font-semibold uppercase tracking-widest px-1.5 py-0.5 rounded bg-cyan-950 text-cyan-400 border border-cyan-800/50">
                  AI
                </span>
              </div>
              <p className="text-[11px] text-slate-400 font-medium">Water Intelligence Core</p>
            </div>
          </div>
        ...
        <div className="mx-4 my-4 p-3 rounded-xl bg-slate-800/60 border border-slate-700/50">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-slate-200">Acoustic AI Engine</span>
            </div>
          ...
          <div className="flex items-center justify-between text-[11px] text-slate-400">
            <span className="flex items-center gap-1">
              <Zap className="w-3 h-3 text-amber-400" /> Latency: 42ms
            </span>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-slate-700 flex items-center justify-center font-bold text-xs text-cyan-400 border border-cyan-500/30">
              MW
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs font-semibold text-slate-200 truncate">Metro Water Utility</p>
              <p className="text-[10px] text-slate-400 truncate">Control Room Oper. #402</p>
            </div>
          </div>
        </div>
      </aside>
